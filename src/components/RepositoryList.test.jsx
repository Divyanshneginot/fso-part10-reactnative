...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent('1.6k'); // forksCount
      expect(firstRepositoryItem).toHaveTextContent('21.9k'); // stargazersCount
      ...
      expect(secondRepositoryItem).toHaveTextContent('1.8k'); // stargazersCount
